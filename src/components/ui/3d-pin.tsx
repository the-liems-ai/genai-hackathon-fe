    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start  rounded-2xl bg-[url('./public/bg.png')] bg-center bg-cover border border-white/[0] group-hover/pin:border-white/[0.2] group-hover/pin:shadow-white/[0.5] group-hover/pin:shadow-xl transition duration-700 overflow-hidden"
        >
  ...
  return (
    <motion.div className="pointer-events-none  w-96 h-[550px] flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-700">
      <div className=" w-full h-full -mt-7 flex inset-0">
        ...
        <>
          <motion.div className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-20 group-hover/pin:h-60 blur-[4px]" />
